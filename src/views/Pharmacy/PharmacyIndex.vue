  ...
  <div class="mt-10 max-w-[900px] mx-auto min-h-screen container-md  ">
    <div class="flex justify-end m-2 p-2">
      <RouterLink
        ...
        class="px-4 py-2 mr-4 bg-green-600 hover:bg-green-800 rounded text-white overflow-auto shadow-black"
      >
        New pharmacy
      </RouterLink>
    </div>
    <div class="relative overflow-x-auto shadow-black rounded-md">
           ...
           <td class="px-6 py-4">{{ pharmacies.address }}</td>
            <td class="px-6 py-4">
              <RouterLink
                ...
                class="px-4 py-2 m-4 bg-green-600 hover:bg-green-800 rounded text-white shadow-black"
              >
              Edit
              </RouterLink>
              <button
                type="submit"
                class="py-2 m-4 bg-red-600 hover:bg-red-800 rounded text-white shadow-black px-2"
